...
const SignUpTeacherView = () => {
    ...
    return (
        <div className="h-screen overflow-y-scroll scrollbar p-10 pb-20 flex flex-col gap-6 items-center justify-start w-full">
            ...
            <h1 className="font-bold text-3xl">Đăng ký tài khoản giáo viên tại EL</h1>
            <div>
                <p className="font-light text-slate-600 text-md text-center text-wrap">
                    Bạn muốn sử dụng ELearning Academy trong lớp học của mình?
                </p>
            </div>
...
export default SignUpTeacherView;
